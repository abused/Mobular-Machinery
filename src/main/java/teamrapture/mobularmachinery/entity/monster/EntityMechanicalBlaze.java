...
public class EntityMechanicalBlaze extends EntityMob implements IAnimatedEntity
{
    ...
    private static final DataParameter<Byte> ON_FIRE = EntityDataManager.<Byte>createKey(EntityMechanicalBlaze.class, DataSerializers.BYTE);

    public EntityMechanicalBlaze(World worldIn)
    {
        super(worldIn);
    ...
    public static void registerFixesMechanicalBlaze(DataFixer fixer)
    {
        EntityLiving.registerFixesMob(fixer, EntityMechanicalBlaze.class);
    }

    protected void initEntityAI()
    {
        this.tasks.addTask(4, new EntityMechanicalBlaze.AIFireballAttack(this));
    ...
    static class AIFireballAttack extends EntityAIBase
        {
            private final EntityMechanicalBlaze blaze;
            private int attackStep;
            private int attackTime;

		public AIFireballAttack(EntityMechanicalBlaze blazeIn)
            {
                this.blaze = blazeIn;
                this.setMutexBits(3);
            }
