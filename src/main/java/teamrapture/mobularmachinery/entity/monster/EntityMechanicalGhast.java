...
public class EntityMechanicalGhast extends EntityFlying implements IMob {
	...
	public EntityMechanicalGhast(World worldIn) {
		super(worldIn);
		
		this.setSize(4.0F, 4.0F);
		this.isImmuneToFire = true;
		this.experienceValue = 5;
		this.moveHelper = new EntityMechanicalGhast.GhastMoveHelper(this);
	}

	protected void initEntityAI() {
		this.tasks.addTask(5, new EntityMechanicalGhast.AIRandomFly(this));
		this.tasks.addTask(7, new EntityMechanicalGhast.AILookAround(this));
		this.tasks.addTask(7, new EntityMechanicalGhast.AIFireballAttack(this));
	...
	public boolean attackEntityFrom(DamageSource source, float amount) {
		if (this.isEntityInvulnerable(source)) {
			return false;
		} else if (source.getImmediateSource() instanceof EntitySteamStream
	...
	public static void registerFixesGhast(DataFixer fixer) {
		EntityLiving.registerFixesMob(fixer, EntityMechanicalGhast.class);
	}
	...
	static class AIFireballAttack extends EntityAIBase {
		private final EntityMechanicalGhast parentEntity;
		public int attackTimer;

		public AIFireballAttack(EntityMechanicalGhast ghast) {
	...
	static class AILookAround extends EntityAIBase {
		...
		public AILookAround(EntityMechanicalGhast ghast) {
			this.parentEntity = ghast;
			this.setMutexBits(2);
		}
	...
	static class AIRandomFly extends EntityAIBase {
		...
		public AIRandomFly(EntityMechanicalGhast ghast) {
			this.parentEntity = ghast;
			this.setMutexBits(1);
		}
	...
	static class GhastMoveHelper extends EntityMoveHelper {
		...
		public GhastMoveHelper(EntityMechanicalGhast ghast) {
			super(ghast);
			this.parentEntity = ghast;
		}
