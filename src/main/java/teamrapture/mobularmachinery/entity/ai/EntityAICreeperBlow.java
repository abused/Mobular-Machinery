package teamrapture.mobularmachinery.entity.ai;

import net.minecraft.entity.EntityLivingBase;
import net.minecraft.entity.ai.EntityAIBase;
import teamrapture.mobularmachinery.entity.monster.EntityMechanicalCreeper;

public class EntityAICreeperBlow extends EntityAIBase
{
    /** The creeper that is swelling. */
    EntityMechanicalCreeper swellingCreeper;
    /** The creeper's attack target. This is used for the changing of the creeper's state. */
    EntityLivingBase creeperAttackTarget;

    public EntityAICreeperBlow(EntityMechanicalCreeper EntityMechanicalCreeperIn)
    {
		this.swellingCreeper = EntityMechanicalCreeperIn;
        this.setMutexBits(1);
    }
