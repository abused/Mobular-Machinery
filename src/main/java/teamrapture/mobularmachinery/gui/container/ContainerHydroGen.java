...
public class ContainerHydroGen extends Container {
    ...
    private TileEntityHydroGen tileHydroGen;

    public ContainerHydroGen(IInventory playerInv, TileEntityHydroGen te) {
        super();
        this.tileHydroGen = te;
        //input
        addSlotToContainer(new SlotInput(this.tileHydroGen.inventory, 0, 55, 15));
